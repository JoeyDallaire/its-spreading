...
public class DialogueLines
{
    ...
    public List<Dialogue> getLinesList()
    {
        ...
        _dialogues.Add(new Dialogue( "Woof-Woof!" ,2));//1
        ...
        _dialogues.Add(new Dialogue( "Where are we? This doesn't make sense. I feel like we were just here a moment ago... were we?" ,1));//10
        ...
        _dialogues.Add(new Dialogue( "No no no this doesn't make sense. I'm certain we were just here. What's going on. I just want to leave. " ,1));//17
        _dialogues.Add(new Dialogue( "Oh now what the fuck is that. Why is the door up there. This is starting to scare me I just want to leave." ,1));//18
        ...
        _dialogues.Add(new Dialogue( "Door is blocked again. I need to find a way through." ,1));//24
        _dialogues.Add(new Dialogue( "We're back here, again, and again, and again and.... wait. Tsuki? Tsuki! Can you hear me? Where are you?!" ,1));//25
        _dialogues.Add(new Dialogue( "It's not Tsuki style to run away something's not right. I hope she's fine, please let her be fine." ,1));//26
        _dialogues.Add(new Dialogue( "There's some type of writing on the walls. What does any of that means?!" ,1));//27
        _dialogues.Add(new Dialogue( "Is something... or someone, threatening me?" ,1));//28
        _dialogues.Add(new Dialogue( "Back here again... what a surprise. Sill no traces of Tsuki..." ,1));//29
        ...
        _dialogues.Add(new Dialogue( "Something is off. I don't feel good about this. " ,1));//35
        _dialogues.Add(new Dialogue( "What the fuck IS this?! Tsuki is that you?! It can't be, it can't be." ,1));//36
        _dialogues.Add(new Dialogue( "I feel weird... My head hurts and my limbs feel tingly." ,1));//37
        _dialogues.Add(new Dialogue( "I just want to go home with Tsuki, why is all of this happening. " ,1));//38
        _dialogues.Add(new Dialogue( "I need to go on..." ,1));//39
        ...
        _dialogues.Add(new Dialogue( "I'm so sorry Tsuki I dont't know what to do, I don't want this." ,1));//43
